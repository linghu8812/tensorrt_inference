...
# opencv 安装
RUN bash -xc "curl -O https://github.com/opencv/opencv/archive/4.7.0.zip && unzip opencv-4.7.0.zip && mv opencv-4.7.0 opencv && \
    curl -O https://github.com/opencv/opencv_contrib/archive/4.7.0.zip && unzip opencv_contrib-4.7.0.zip && mv opencv_contrib-4.7.0 opencv_contrib && \
