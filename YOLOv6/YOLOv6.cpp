...
YOLOv6::YOLOv6(const std::string &config_file) {
    YAML::Node root = YAML::LoadFile(config_file);
    YAML::Node config = root["YOLOv6"];
...
bool YOLOv6::InferenceFolder(const std::string &folder_name) {
...
void YOLOv6::EngineInference(const std::vector<std::string> &image_list, const int &outSize, void **buffers,
...
std::vector<float> YOLOv6::prepareImage(std::vector<cv::Mat> &vec_img) {
...
std::vector<std::vector<YOLOv6::DetectRes>> YOLOv6::postProcess(const std::vector<cv::Mat> &vec_Mat, float *output,
                                                                const int &outSize) {
...
void YOLOv6::NmsDetect(std::vector<DetectRes> &detections) {
...
float YOLOv6::IOUCalculate(const YOLOv6::DetectRes &det_a, const YOLOv6::DetectRes &det_b) {
