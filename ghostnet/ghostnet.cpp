...
GhostNet::GhostNet(const std::string &config_file) {
...
GhostNet::~GhostNet() = default;

void GhostNet::LoadEngine() {
...
bool GhostNet::InferenceFolder(const std::string &folder_name) {
...
void GhostNet::EngineInference(const std::vector<std::string> &image_list, const int &outSize, void **buffers,
...
std::vector<float> GhostNet::prepareImage(std::vector<cv::Mat> &vec_img) {
