...
SEResNeXt::SEResNeXt(const std::string &config_file) {
...
SEResNeXt::~SEResNeXt() = default;

void SEResNeXt::LoadEngine() {
...
bool SEResNeXt::InferenceFolder(const std::string &folder_name) {
...
void SEResNeXt::EngineInference(const std::vector<std::string> &image_list, const int &outSize, void **buffers,
...
std::vector<float> SEResNeXt::prepareImage(std::vector<cv::Mat> &vec_img) {
